...
export function CardEffectsComponent() {
  return (
    <Card>
  ...
  return (
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      ...
      <div className="h-40 w-px absolute top-20 m-auto z-40 bg-gradient-to-b from-transparent via-cyan-500 to-transparent animate-move">
        ...
        <Suspense fallback={<div className="text-sm">Loading sparkles...</div>}>
        <Sparkles />
      </Suspense>
        </div>
      </div>
...
if (typeof window === "undefined") return null;
  ...
  const randomScaleY = () => Math.random() * 0.5 + 0.5;
  const randomScaleZ = () => Math.random() * 0.5 + 0.5;
  ...
  const randomSkewX = () => Math.random() * 20 - 10;
  const randomSkewY = () => Math.random() * 20 - 10;
  const randomSkewZ = () => Math.random() * 20 - 10;
  const randomPerspective = () => Math.random() * 1000 + 500;
  const randomTransformOrigin = () =>
