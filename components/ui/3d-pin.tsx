      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2 flex justify-start items-start rounded-2xl shadow-[0_8px_16px_rgb(0_0_0/0.4)] 
            ...
            group-hover/pin:border-black/20 dark:group-hover/pin:border-white/20 
    ...
    <motion.div className="pointer-events-none w-96 h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
      <div className="w-full h-full -mt-7 flex-none inset-0">
        ...
        <div className="absolute top-0 inset-x-0 flex justify-center">
          ...
          >
            <span className="relative z-20 text-xs font-bold inline-block py-0.5 text-black dark:text-white"
            >
              {title}
            </span>
        ...
        >
          {[0, 2, 4].map((delay) => (
            <motion.div
              ...
              className="absolute left-1/2 top-1/2 h-[11.25rem] w-[11.25rem] rounded-full 
